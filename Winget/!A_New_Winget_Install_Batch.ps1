...
winget install Toxblh.WinToLinux #WinToLinux #!Dual boot Linux on Windows
winget install Paragon.LinuxFileSystems #Paragon Linux File Systems for Windows
winget install REALiX.HWiNFO #HWiNFO
winget install Git.Git #Git Version Control
winget install 9PHHPRJ65T1Z #Lua Script Test
winget install 15722UsefulApp.WorkspaceLauncherForVSCode #Visual Studio / Code for Command Palettewinget install 9N2TLT3LFTD8 #Lua Code Studio
...
winget install RevoLand.Steam-Library-Manager #Steam Library Manager
winget install Romanitho.Winget-AutoUpdate #Winget AutoUpdate
winget install RoniLehto.LMath #LMath
